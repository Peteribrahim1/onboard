...
class AppColor {
  ...
  static const Color kSecondaryblueColor = Color(0xFFE9F7FF);
  ...
  static const Color kLightRedColor = Color(0xFFFFF4E3);
  static const Color kSecondaryRedcolor = Color(0xFFED9D21);
  static const Color kCalenderSelectedBG = Color(0xFFE9EDF0);
